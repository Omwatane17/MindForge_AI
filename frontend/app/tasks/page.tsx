    ...
    <AppLayout>
      <div className="page">
        <div className="page-header flex items-center justify-between flex-wrap gap-16">
          ...
          {selectedProject && (
            <ExportPdfButton
              project={projectDetail?.project || selectedProject}
              projectId={selectedProject.id}
              tasks={projectDetail?.tasks || tasks}
              dependencies={projectDetail?.dependencies || dependencies}
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <Link href="/dashboard" className="btn btn-primary mt-16">Go to Dashboard</Link>
          </div>
        ) : (
          <>
            {/* Project selector */}
