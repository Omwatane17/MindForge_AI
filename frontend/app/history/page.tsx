      ...
      <div className="page">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <Link href="/dashboard" className="btn btn-primary mt-16">Create Your First Project</Link>
          </div>
        ) : (
                ...
                <div key={project.id} id={`history-${project.id}`} className="card" style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                      <Link href={`/dashboard?projectId=${project.id}`} className="btn btn-ghost btn-sm">
                        View
                      </Link>
