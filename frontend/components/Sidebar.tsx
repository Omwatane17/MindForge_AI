    ...
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        <Link
          ...
          style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px' }}
        ...
        >
          <img
            ...
            width={118}
            height={38}
            style={{ height: 34, width: 'auto', aspectRatio: '118 / 38', objectFit: 'contain', display: 'block' }}
          />
        </Link>
