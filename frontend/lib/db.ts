...
const DB_PATH = process.env.DATABASE_PATH || path.resolve(process.cwd(), '../backend/database/mindforge.db');
...
function initializeSchema() {
  ...
  database.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_calendar_user ON calendar_availability(user_id);
  `);
}
